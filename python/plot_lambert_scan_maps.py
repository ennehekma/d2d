...
# for i in xrange(0,departure_epochs.size):
    ...
    scan_data.loc[scan_data['transfer_delta_v'] > 1.0, 'transfer_delta_v'] = 1.0
    scan_order = scan_data.sort_values(str(map_order))                                            \
                          .drop_duplicates('departure_object_id')[                                \
                              ['departure_object_id',str(map_order)]]


    # print scan_data.size-1
    # for x in xrange(0,12):
    #     if scan_data['transfer_delta_v'][x]>1.0:
    #         # print scan_data['transfer_delta_v'][x]

    #         scan_data['transfer_delta_v'][x]=1.0
