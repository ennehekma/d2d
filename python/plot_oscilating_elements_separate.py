...
output_path_prefix1 = config["output_directory"] + str(config["tag"]) + "_" 
...
for x in xrange(1,4,1):
	if x==1:
		oscilating_elements = oscilating_elements_half
		output_path_prefix = output_path_prefix1 + "BStar_halfmean_"
	if x==2:
		oscilating_elements = oscilating_elements
		output_path_prefix = output_path_prefix1 + "BStar_mean_"
	if x==3:
		oscilating_elements = oscilating_elements_twice
		output_path_prefix = output_path_prefix1 + "BStar_twicemean_"
