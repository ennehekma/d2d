...
ax1.scatter(transfer_path['x'][transfer_path.index[-1]]-arrival_path['x'][transfer_path.index[-1]], \
            transfer_path['y'][transfer_path.index[-1]]-arrival_path['y'][transfer_path.index[-1]],s=100,marker='o',color='r')
...
ax2.scatter(transfer_path['x'][0]-arrival_path['x'][0],transfer_path['z'][0]-arrival_path['z'][0],s=100,marker='o',color='g')
ax2.scatter(transfer_path['x'][transfer_path.index[-1]]-arrival_path['x'][[transfer_path.index[-1]]], \
            transfer_path['z'][transfer_path.index[-1]]-arrival_path['z'][[transfer_path.index[-1]]],s=100,marker='o',color='r')
...
ax3.scatter(transfer_path['y'][0]-arrival_path['y'][0],transfer_path['z'][0]-arrival_path['z'][0],s=100,marker='o',color='g')
ax3.scatter(transfer_path['y'][transfer_path.index[-1]]-arrival_path['y'][transfer_path.index[-1]], \
            transfer_path['z'][transfer_path.index[-1]]-arrival_path['z'][transfer_path.index[-1]],s=100,marker='o',color='r')
