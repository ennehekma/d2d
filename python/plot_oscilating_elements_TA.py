...
plt.plot(oscilating_elements['TAcontinous'][0:-1],oscilating_elements['a'][0:-1],linewidth=2,label='Atom')
plt.plot(oscilating_elements['TAcontinous'][0:-1],oscilating_elements['La'][0:-1],label='Lambert',linewidth=2)
