...
ax1.plot(arrival_path['x'][1:],arrival_path['y'][1:],color='k')
# ax1.scatter(transfer_path['x'][0]-arrival_orbit['x'][0],transfer_path['y'][0]-arrival_orbit['y'][0],s=100,marker='o',color='g')
...
ax2.plot(arrival_path['x'],arrival_path['z'],color='k')
...
ax3.plot(arrival_path['y'],arrival_path['z'],color='k')
